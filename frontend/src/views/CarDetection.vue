        ...
        <el-card style="border-radius: 8px">
          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="检测到的目标" name="first">
              ...
              <el-table :data="feature_list" style="width: 100%">
                <el-table-column prop="plate_num" label="车牌号" width="180" />
                <el-table-column prop="plate_color" label="车牌颜色" width="180" />
              </el-table>
            </el-tab-pane>
          </el-tabs>
        </el-card>
    ...
    update(e) {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.percentage = 100;
          clearInterval(timer);
          this.url_1 = response.data.resources.url1;
          this.srcList.push(this.url_1);
          this.url_2 = response.data.resources.url2
          // this.url_2 = response.data.draw_url;
          this.srcList1.push(this.url_2);
          this.fullscreenLoading = false;
          this.loading = false;

          this.feat_list = Object.keys(response.data.info);
          ...
          // }
          const plate = {
            'plate_num':  response.data.info.plate_num,
            'plate_color': response.data.info.plate_color
          }
          this.feature_list.push(plate);
