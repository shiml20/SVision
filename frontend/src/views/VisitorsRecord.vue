<template>
    <div class="visitors-container">
        ...
        <div class="visitors-info">
            <div class="info-left">
                <span>当日入营人员</span>
                <span class="num-left">251人</span>
            </div>
            <div class="info-mid">
                <span>当日出营人员</span>
                <span class="num-mid-1">300人</span>
            </div>
            <div class="info-mid">
                <span>重点部门人员</span>
                <span class="num-mid-2">28人</span>
            </div>
            <div class="info-right">
                <span>重点关注人员</span>
                <span class="num-right">15人</span>
            </div>
        </div>
        <!-- 搜索栏 -->
        <!-- 信息提示栏 -->
        ...
        <div id="big">
            <el-scrollbar height="700px">
                <el-table :data="resources" :default-sort="{ prop: 'id', order: 'descending' }" border
                    ...
                    <el-table-column prop="type" label="访客类型" align="center" />
                    ...
                    <el-table-column prop="visitplace" label="访问地点" align="center" />
                    <el-table-column prop="phone" label="联系方式" align="center" />
                    <el-table-column prop="company" label="访客公司" align="center" />
                    <el-table-column fixed="right" label="操作" align="center">
                        <template #default="scope">
                            <el-button size="small"
                                @click="dialogUpdateVisible = true; editResForm.name = scope.row.name ">编辑</el-button>
            ...
            <el-dialog v-model="dialogAddVisible" title="Add Dialog">
                <el-form :model="addResForm">
                    ...
                    <el-form-item label="访客类型" :label-width="formLabelWidth">
                        <el-input v-model="addResForm.type" autocomplete="off" placeholder="输入访客类型" />
                    </el-form-item>
                    ...
                    <el-form-item label="入营时间" :label-width="formLabelWidth">
                        ...
                        <div class="block">
                            ...
                            <el-date-picker v-model="addResForm.intime" type="datetime"
                    ...
                    <el-form-item label="出营时间" :label-width="formLabelWidth">
                        ...
                        <div class="block">
                            <!-- <span class="demonstration">With shortcuts</span> -->
                            <el-date-picker v-model="addResForm.outtime" type="datetime"
                                placeholder="Select date and time" :shortcuts="shortcuts"
                    ...
                    <el-form-item label="访问地点" :label-width="formLabelWidth">
                        <el-input v-model="addResForm.visitplace" autocomplete="off" placeholder="访问地点" />
                    </el-form-item>
                    <el-form-item label="联系方式" :label-width="formLabelWidth">
                        <el-input v-model="addResForm.phone" autocomplete="off" placeholder="联系方式" />
                    </el-form-item>
                    <el-form-item label="访客公司" :label-width="formLabelWidth">
                        <el-input v-model="addResForm.company" autocomplete="off" placeholder="访客公司" />
                    </el-form-item>
                </el-form>
                <template #footer>
                    <span class="dialog-footer">
                        ...
                        <el-button v-if="addResForm.name != ''" type="primary"
            ...
            <el-dialog v-model="dialogUpdateVisible" title="Update dialog">
                <el-form :model="editResForm">
                    <el-form-item label="访客姓名" :label-width="formLabelWidth">
                        <el-input v-model="editResForm.name" autocomplete="off" placeholder="输入姓名" />
                    </el-form-item>
                    <el-form-item label="访客类型" :label-width="formLabelWidth">
                        <el-input v-model="editResForm.type" autocomplete="off" placeholder="输入访客类型" />
                    </el-form-item>
                    <el-form-item label="出入类型" :label-width="formLabelWidth">
                    ...
                    <el-form-item label="入营时间" :label-width="formLabelWidth">
                        ...
                        <div class="block">
                            <!-- <span class="demonstration">With shortcuts</span> -->
                            <el-date-picker v-model="editResForm.intime" type="datetime"
                                placeholder="Select date and time" :shortcuts="shortcuts" />
                        </div>
                    </el-form-item>
                    ...
                    <el-form-item label="出营时间" :label-width="formLabelWidth">
                        ...
                        <div class="block">
                            <!-- <span class="demonstration">With shortcuts</span> -->
                            <el-date-picker v-model="editResForm.outtime" type="datetime"
                                placeholder="Select date and time" :shortcuts="shortcuts"
                                format="YYYY/MM/DD HH:mm:ss" />
                        </div>
                    </el-form-item>
                    ...
                    <el-form-item label="访问地点" :label-width="formLabelWidth">
                        <el-input v-model="editResForm.visitplace" autocomplete="off" placeholder="访问地点" />
                    </el-form-item>
                    <el-form-item label="联系方式" :label-width="formLabelWidth">
                        <el-input v-model="editResForm.phone" autocomplete="off" placeholder="联系方式" />
                    </el-form-item>
                    <el-form-item label="访客公司" :label-width="formLabelWidth">
                        <el-input v-model="editResForm.company" autocomplete="off" placeholder="访客公司" />
                    </el-form-item>
                </el-form>
                <template #footer>
                    <span class="dialog-footer">
                        ...
                        <el-button @click="onReset">Reset</el-button>
                        <el-button v-if="editResForm.name != ''" type="primary"
...
function getResources() {
    ...
    const _path = 'http://127.0.0.1:5000/visitors/search'
...
function addRes(payload: {}) {
    const _path = 'http://127.0.0.1:5000/visitors/'
...
function onSubmit() {
    ...
    const payload = {
        ...
        intime: intimestr,
        outtime: outtimestr,
        visitplace: addResForm.visitplace,
        phone: addResForm.phone,
        company: addResForm.company
    };
    addRes(payload)
    initForm()
}
...
function onSubmitUpdate() {
    ...
    console.log(payload)
    updateRes(payload, editResForm.name)
    initForm()
}

function updateRes(payload: {}, id: any) {
    const _path = `http://localhost:5000/visitors/${id}`
